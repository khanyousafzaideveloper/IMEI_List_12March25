...
fun FeedbackScreen(navController: NavController) {
    ...
    Column(
        ...
        Text(text = "We Value Your Feedback", fontSize = 24.sp, color = Color.White)
        Spacer(modifier = Modifier.height(8.dp))
        Text(text = "Please provide your details and feedback below.", fontSize = 16.sp, color = Color.White)
...
@Preview(showBackground = true, backgroundColor = 311L)
@Composable
